...
Bert_path = r"/mnt/workspace/LLM/bert-base-uncased"
Llama_path = r"/mnt/workspace/LLM/Meta-Llama-3-8B"

#
# data_path = r'/Users/guoqijun/code/logllm/DATA/test.csv'
# Bert_path = r"/Users/guoqijun/code/logllm/bert-base-uncased"
# Llama_path = r"/Users/guoqijun/code/logllm/Meta-Llama-3-8B"
...
def evalModel(model, dataset, batch_size):
    ...
    with torch.no_grad():
        ...
        for bathc_i in tqdm(range(batch_size, len(indexes) + batch_size, batch_size)):
            ...
            print("给model的数据", this_batch_seqs)
